      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-white transition hover:opacity-75"> Help </a>
            </li>
        ...
        <div>
          <p className="font-medium text-white">View Website in</p>

          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-white transition hover:opacity-75"> English </a>
            </li>

            <li>
              <a href="#" className="text-white transition hover:opacity-75"> Indonesian </a>
            </li>

            <li>
              <a href="#" className="text-white transition hover:opacity-75"> Deutsch </a>
            </li>
          </ul>
        </div>
