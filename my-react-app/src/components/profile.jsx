...
const Profile = () => {
    ...
    const dropdownToggle = () => setIsOpen(prev => !prev);
    ...
    return (
        <div className="relative font-[sans-serif] w-max mx-auto "   ref={dropdownRef}>
            <button
                ...
                className="px-4 h-10 flex items-center rounded-full text-black text-sm border border-gray-300   hover:bg-gray-100"
            >
                <img
            ...
            {isOpen && (
                <ul className='absolute block shadow-lg bg-black py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto'>
                    <li
                        onClick={() => handleOptionClick('Furniture Store')}
